          ...
          <div className="app-flex app-flex-column app-full-width app-overflow-scroll">
            <div>
              <iframe
                ...
                src={`https://player.twitch.tv/?channel=${props.location.state.data.user_name}&muted=true&parent=videoappclient-4h499ir9c-dnjsskarb7s-projects.vercel.app&parent=videoappclient-4h499ir9c-dnjsskarb7s-projects.vercel.app`}
                frameBorder="0"
                scrolling="<scrolling>"
                allowFullScreen
              ></iframe>
